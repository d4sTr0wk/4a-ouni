...
;       The address of 'first_reg' (byte) (global) is 0x028
;       The address of 'last_reg' (byte) (global) is 0x029
;       The address of 'solution' (byte) (global) is 0x02B
;       The address of 'display' (byte) (global) is 0x027
;       The address of 'flagrb' (bit) (global) is 0x02A,0
	ORG 0x0000
	BCF PCLATH,3
	BCF PCLATH,4
	GOTO L0003
